...
export async function executeJob(request: any): Promise<ExecuteJobResult> {
  ...
  if (roll < 0.40) {
    prize = "🥉 Bronze Box"; multiplier = "0.5x";
  } else if (roll < 0.70) {
    prize = "🥈 Silver Box"; multiplier = "1x";  
  } else if (roll < 0.85) {
    prize = "🥇 Gold Box"; multiplier = "2x";
  } else if (roll < 0.95) {
    prize = "💎 Diamond Box"; multiplier = "3x";
  } else {
    prize = "🌟 LEGENDARY BOX"; multiplier = "10x";
  }
